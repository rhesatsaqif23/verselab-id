...
export default function LessonList({
  ...
  return (
    <div className="relative flex w-full flex-col items-center">
      ...
      <div
        className="relative flex w-full flex-nowrap items-start justify-start sm:justify-center gap-6 sm:gap-8 md:gap-10 overflow-x-auto py-8 px-6 md:px-8 scrollbar-none"
      >
