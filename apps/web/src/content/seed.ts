...
const unitDefs: UnitDef[] = [
  {
    ...
    lessonIds: ["nabung-awal", "nilai-waktu-uang", "anggaran-bulanan", "hutang-cicilan"],
  },
  {
    id: "akuntansi",
    title: "Akuntansi",
    imageUrl: "/unit/akuntansi.webp",
    lessonIds: ["persamaan", "transaksi", "laba-rugi", "arus-kas"],
  },
  {
    id: "manajemen-produk",
    title: "Manajemen Produk",
    imageUrl: "/unit/manajemen-produk.webp",
    lessonIds: ["menemukan-masalah", "prioritas-fitur", "metrik-produk", "mvp-validasi"],
  },
  {
    id: "kewirausahaan",
    title: "Kewirausahaan",
    imageUrl: "/unit/kewirausahaan.webp",
    lessonIds: ["unit-ekonomi", "titik-impas", "menentukan-harga", "validasi-ide"],
  },
];
...
export function seedContent() {
  ...
  for (const lesson of allLessons) {
    ...
    store
      .getState()
      .addLesson(unitDef.id, { id: lesson.id, title: lesson.title, icon: lesson.icon });
